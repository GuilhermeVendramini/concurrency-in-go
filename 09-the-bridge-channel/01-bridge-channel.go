...
/*
	<1> This is the channel that will return all values from bridge.

	<2> This loop is responsible for pulling channels off of chanStream and providing
	them to a nested loop for use.

	<3> This loop is responsible for reading values off the channel it has been given and
